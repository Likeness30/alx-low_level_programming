...
/**
 * sorted_list - This inserts new node in sorted
...
/**
 * shash_table_create - This creates a sorted hash tables
...
/**
 * shash_table_get - This retrieves value associeted with key
...
/**
 * shash_table_print - This prints the key:value from ht
 * @ht: The pointer to hash table
 */
...
/**
 * shash_table_print_rev - This prints the key:value from ht in reverse
 * @ht: The pointer to hash table
 */
...
/**
 * shash_table_delete - This frees hash table and all nodes
 * @ht: The pointer to hash table
 */
